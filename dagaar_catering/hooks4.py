...
doc_events = {
    ...
    "Catering Emergency Expense": {
        ...
        "on_submit": [
            "dagaar_catering.catering_management.controllers.catering_emergency_expense.on_submit",
            "dagaar_catering.catering_management.controllers.linkers.refresh_cost_sheet_on_event",
        ],
        },
    "Catering Wastage Entry": {
        "validate": "dagaar_catering.catering_management.controllers.catering_wastage_entry.validate",
        "on_submit": [
            "dagaar_catering.catering_management.controllers.catering_wastage_entry.on_submit",
            "dagaar_catering.catering_management.controllers.linkers.refresh_cost_sheet_on_event",
        ],
        "on_cancel": "dagaar_catering.catering_management.controllers.linkers.refresh_cost_sheet_on_event",
    },
    ...
    "Stock Entry": {
        ...
        "on_submit": "dagaar_catering.catering_management.controllers.linkers.refresh_cost_sheet_on_event",
        "on_cancel": "dagaar_catering.catering_management.controllers.linkers.refresh_cost_sheet_on_event",
    },
    "Journal Entry": {
        "on_submit": "dagaar_catering.catering_management.controllers.linkers.refresh_cost_sheet_on_event",
