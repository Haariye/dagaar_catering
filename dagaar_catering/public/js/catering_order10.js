...
function _setup_action_buttons(frm) {
	...
	// Load Items from Packages — appears in Draft when packages are added but items aren't yet
	if (d.docstatus === 0 && d.menu_packages && d.menu_packages.length > 0) {
		frm.add_custom_button(__('🍽 Load Items from Packages'), () => {
